...
import org.aospextended.device.DeviceSettings.DeviceSettings;
...
public class GameModeTileService extends TileService {
    ...
    public void onStartListening() {
        ...
        getQsTile().setState(DeviceSettings.isGamingModeSupported() && GameModeSwitch.isSupported() ? (enabled ? Tile.STATE_ACTIVE : Tile.STATE_INACTIVE) : Tile.STATE_UNAVAILABLE);
