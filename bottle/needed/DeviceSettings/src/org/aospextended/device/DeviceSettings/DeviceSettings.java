...
import org.aospextended.device.DeviceSettings.CustomSeekBarPreference;
import org.aospextended.device.DeviceSettings.SwitchPreference;

import org.aospextended.device.DeviceSettings.DolbySwitch;
import org.aospextended.device.DeviceSettings.FileUtils;
import org.aospextended.device.DeviceSettings.FPSInfoService;
import org.aospextended.device.DeviceSettings.doze.DozeSettingsActivity;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
          if (preference == mFpsInfo) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.aospextended.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
