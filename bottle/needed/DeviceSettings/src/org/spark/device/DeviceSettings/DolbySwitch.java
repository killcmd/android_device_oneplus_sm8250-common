...
public class DolbySwitch {
    private static final String PACKAGE_NAME = "com.dolby.daxappui";
    private static final String CLASS_NAME = "com.dolby.daxappui.MainActivity";
    ...
    public void setEnabled(boolean enabled) {
        ...
        MainActivity.setComponent(mComponentName);
        if (enabled) {
            ...
            mContext.startService(MainActivity);
            return;
        }
        // disable service component and stop service
        mContext.stopService(MainActivity);
        mContext.getPackageManager().setComponentEnabledSetting(mComponentName,
