...
# Fingerprint
TARGET_SURFACEFLINGER_UDFPS_LIB := //device/oneplus/sm8250-common:libudfps_extension.oplus
...
TARGET_KERNEL_ADDITIONAL_FLAGS := BRAND_SHOW_FLAG=oneplus HOSTCFLAGS="-fuse-ld=lld -Wno-unused-command-line-argument" LD=ld.lld LLVM=1 LLVM_IAS=1
...
include device/oneplus/sm8250-common/sepolicy/qti/SEPolicy.mk
